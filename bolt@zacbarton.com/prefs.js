...
function buildPrefsWidget() {
    ...
    let general = new Gtk.Label({
        label: "<b>General</b>",
        use_markup: true,
        xalign: 0
    });
    let vbox3 = new Gtk.Box({
        orientation: Gtk.Orientation.VERTICAL,
        margin_left: 20
    });
    let label31 = new Gtk.CheckButton({
    ...
    let label32 = new Gtk.CheckButton({
        label: "Show home tab when opened"
    });
    ...
    let label37 = new Gtk.CheckButton({
        label: "Change activities text"
    });
    ...
    let label11 = new Gtk.CheckButton({
        label: "Blur overlapping windows"
    });
    ...
    let tabs = new Gtk.Label({
        label: "<b>Tabs</b>",
        use_markup: true,
        xalign: 0
    });
    let vbox6 = new Gtk.Box({
        orientation: Gtk.Orientation.VERTICAL,
        margin_left: 20
    });
    let label33 = new Gtk.CheckButton({
        label: "Applications"
    });
    ...
    let label34 = new Gtk.CheckButton({
        label: "Files"
    });
    ...
    let label35 = new Gtk.CheckButton({
        label: "Contacts"
    });
    ...
    let label36 = new Gtk.CheckButton({
        label: "System"
    });
    ...
    let hbox31 = new Gtk.Box({
        orientation: Gtk.Orientation.HORIZONTAL,
        margin_top: 0,
        margin_left: 0
    });
    let label30 = new Gtk.Button({
        label: "Edit application & system categories"
    });
    ...
    let home = new Gtk.Label({
        label: "<b>Home tab</b>",
        use_markup: true,
        xalign: 0
    });
    let vbox4 = new Gtk.Box({
        orientation: Gtk.Orientation.VERTICAL,
        margin_left: 20
    });
    let label421 = new Gtk.RadioButton({
    ...
    let label422 = new Gtk.RadioButton({
        label: "Show popular applications",
        group: label421
    });
    ...
    let label423 = new Gtk.RadioButton({
        label: "Show favorite applications",
        group: label421
    });
    ...
    let label424 = new Gtk.RadioButton({
    ...
    let label43 = new Gtk.CheckButton({
    ...
    let label44 = new Gtk.CheckButton({
    ...
    let search = new Gtk.Label({
        label: "<b>Search</b>",
        use_markup: true,
        xalign: 0
    });
    let vbox5 = new Gtk.Box({
        orientation: Gtk.Orientation.VERTICAL,
        margin_left: 20
    });
    let label53 = new Gtk.CheckButton({
    ...
    let label54 = new Gtk.CheckButton({
        label: "Contacts"
    });
    ...
    let themeSize = new Gtk.Label({
        label: "<b>Theme size</b> <small><i>(requires theme support)</i></small>",
        use_markup: true,
        xalign: 0
    });
    let vbox17 = new Gtk.Box({
        orientation: Gtk.Orientation.VERTICAL,
        margin_left: 20
    });
    let label171 = new Gtk.RadioButton({
        label: "Large"
    });
    ...
    let label172 = new Gtk.RadioButton({
        label: "Medium",
        group: label171
    });
    ...
    let label173 = new Gtk.RadioButton({
        label: "Small",
        group: label171
    });
    ...
    let theme = new Gtk.Label({
        label: "<b>Default Theme</b>",
        use_markup: true,
        xalign: 0
    });
    let vbox1 = new Gtk.Box({
        orientation: Gtk.Orientation.VERTICAL,
        margin_left: 20
    });
    let label12 = new Gtk.RadioButton({
        label: "Match wallpaper color"
    });
    ...
    let hbox11 = new Gtk.Box({
        orientation: Gtk.Orientation.HORIZONTAL,
        margin_top: 0,
        margin_left: 0
    });
    let custom11 = new Gtk.RadioButton({
        label: "Custom color",
        group: label12
    });
    ...
    let picker11 = new Gtk.ColorButton({
        margin_left: 10
    });
    ...
    let label21 = new Gtk.RadioButton({
        label: "Automattic"
    });
    ...
    let hbox21 = new Gtk.Box({
        orientation: Gtk.Orientation.HORIZONTAL,
        margin_top: 0,
        margin_left: 0
    });
    let custom21 = new Gtk.RadioButton({
        label: "Custom",
        group: label21
    });
    ...
    if (!Zeitgeist.available || !thumbnail_factory) {
        ...
        if (!Zeitgeist.available) {
            notice = new Gtk.Label({
                label: "Please install zeitgeist and relogin.",
                use_markup: true,
                xalign: 0
            });
        } else {
            notice = new Gtk.Label({
                label: "To see previews of some files install <b>gir1.2-gnomedesktop-3.0</b> and relogin.",
                use_markup: true,
                xalign: 0
            });
        }
    ...
    let donate = new Gtk.Label({
        label: "<a href='https://flattr.com/thing/668930'>Donate to this project</a>",
        use_markup: true,
        xalign: 0,
        margin_top: 20
    });
